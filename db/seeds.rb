...
Vote.create(voter_id: 6, voteable_type: "Answer", voteable_id: 1)
Vote.create(voter_id: 5, voteable_type: "Answer",voteable_id: 2)
Vote.create(voter_id: 1, voteable_type: "Answer", voteable_id: 3)
Vote.create(voter_id: 6, voteable_type: "Question", voteable_id: 3)
Vote.create(voter_id: 5, voteable_type: "Question", voteable_id: 3)
Vote.create(voter_id: 4, voteable_type: "Question", voteable_id: 2)
Vote.create(voter_id: 3, voteable_type: "Question", voteable_id: 2)
Vote.create(voter_id: 2, voteable_type: "Question", voteable_id: 1)
Vote.create(voter_id: 1, voteable_type: "Question", voteable_id: 1)
Vote.create(voter_id: 6, voteable_type: "Comment", voteable_id: 1)
Vote.create(voter_id: 5, voteable_type: "Comment", voteable_id: 1)
Vote.create(voter_id: 4, voteable_type: "Comment", voteable_id: 2)
Vote.create(voter_id: 3, voteable_type: "Comment", voteable_id: 2)
Vote.create(voter_id: 2, voteable_type: "Comment", voteable_id: 3)
Vote.create(voter_id: 1, voteable_type: "Comment", voteable_id: 4)
Vote.create(voter_id: 4, voteable_type: "Comment", voteable_id: 5)
Vote.create(voter_id: 3, voteable_type: "Answer", voteable_id: 5)
Vote.create(voter_id: 4, voteable_type: "Answer", voteable_id: 4)
Vote.create(voter_id: 2, voteable_type: "Answer", voteable_id: 6)
